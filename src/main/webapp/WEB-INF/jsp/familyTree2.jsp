...
<head>
	...
	<link rel="stylesheet" href='<c:url  value="jquery-ui-1.10.2.custom.css"/>'/>
	<script type="text/javascript" src='<c:url value="js/jquery-1.9.1.js" />'></script>
	<script type="text/javascript" src='<c:url value="js/jquery-ui-1.10.2.custom.min.js" />'></script>

	<!-- # include file="src/src.primitives.html"-->
	<script type="text/javascript" src=' <c:url value="js/primitives.min.js?3710"/>'></script>
	<link href='<c:url value="css/primitives.latest.css?2106"/>' media="screen" rel="stylesheet" type="text/css" />
...
<body>
	<div id="orgdiagram" style="width: 640px; height: 480px; position: absolute; overflow: hidden; border-style: dotted; border-width: 1px;"></div>
	<div id="btn50">50%</div>
